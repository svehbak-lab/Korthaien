...
import { kroner, kreditt, total, antallKort, sortert, prisFor, COND_NAVN } from "../api.js";
...
export function Gjennomgang({ kurv, onAntall, onCondition, onTilbake, onVidere, minOrdreØre }) {
  const linjer = sortert(kurv);
  const sum = total(kurv);
